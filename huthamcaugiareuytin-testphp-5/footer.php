        <div id="footer" style="background-color: #51c102;">
            ...
            <script>
                if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) { document.getElementById("linkzalo").href = "https://zalo.me/0939110100"; }
            </script>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <p><span class="text-danger">Hotline:</span> <a class="d-inline" href="tel:0976150170">0976 150
                                170</a></p>
