...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('fontawesome-free-6.2.0/css/all.min.css') }}">
    <script src="{{ asset('js/jquery.min.js') }}"></script>
    <title>Trang chủ - Hút hầm cầu giá rẻ uy tín</title>
</head>

<body>
    <div id="site">
        <div id="wrapper" class="bg-light">
            <div id="header" class="p-0 mb-0">
            ...
            <div class="container only-pc">
                <div class="row">
                    <div class="col-12 pl-0">
                        <nav class="navbar navbar-expand-sm pl-0 pb-0">
                            <a class="navbar-brand" href="{{ url('/') }}"><img src="{{ asset('images/456.png') }}"
