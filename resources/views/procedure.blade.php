...
@section('content')
    ...
    <div class="row" style="background-color: rgb(196, 228, 196);">
        <div class="container pt-5 developing">
            <h2 class="mb-5 text-center text-white">Hệ thống đang được phát triển. Xin quý khách vui lòng quay lại sau!</h2>
            <h1 class="text-center">Vui lòng gọi số: <a class="d-inline" style="font-size: 50px; font-weight:bold;"
                    href="tel:0976150170">0976 150 170</a> hoặc <a class="d-inline" style="font-size: 50px;font-weight:bold;"
                    href="tel:0939110100">0939 110 100</a></h1>
            <h1 class="text-center">để được tư vấn dịch vụ môi trường!</h1>
